...
Languages & ML: Python, SQL, Pandas, Scikit-learn, NumPy

ML/LLM: LangChain, ChromaDB, OpenAI API, TensorFlow basics

Data & Cloud: BigQuery, Streamlit, Data validation frameworks

DevOps: Git, Docker basics, CI/CD fundamentals
